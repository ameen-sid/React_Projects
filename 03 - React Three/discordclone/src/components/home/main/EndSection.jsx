		...
		<section className="bg-[#f4f4f4] w-screen h-[175vh] px-12 py-24">
			<div className="w-[60%] m-auto">
				...
				<p className="text-xl text-center">
					...
					room. Wave hello over video, watch friends stream their
			...
			<div className="w-[40vw] m-auto flex flex-col items-center">
				<h4 className="text-center text-3xl font-bold my-12">
					Ready to start your journey?
				</h4>
				<button className="bg-[#5865f2] text-white text-xl font-medium py-[12px] px-[24px] rounded-3xl hover:font-bold">
