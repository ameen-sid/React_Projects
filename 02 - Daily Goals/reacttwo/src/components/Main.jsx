...
const Main = () => {
	...
	return (
		<main className="w-[60vw] min-h-[90vh] max-[800px]:w-[80vw] self-center p-4 max-[800px]:p-3 px-16 bg-yellow-300 flex flex-col items-center">
			<span className="font-bold text-[6vw] max-[800px]:text-[8vw] m-4">
				Daily Goals
			</span>
			<form onSubmit={submitHandler} className="w-full m-8">
				...
				<textarea
					...
					className="w-full border-2 border-slate-400 rounded p-2 my-2"></textarea>
				<button className="w-full bg-black text-white rounded p-2 font-semibold my-2">
					ADD
				</button>
			</form>
